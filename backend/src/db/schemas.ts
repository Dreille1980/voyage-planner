...
export const CreateTripSchema = z.object({
  ...
  groupType: z.array(z.enum(["solo", "couple", "famille", "amis", "autre"])).optional(),
  numberOfPeople: z.number().int().positive().optional(),
  tripGoal: z.array(z.enum(["detente", "tourisme", "sport", "gastronomie", "culturel", "affaires", "autre"])).optional(),
